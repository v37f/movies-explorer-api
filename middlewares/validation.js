  ...
  body: Joi.object().keys({
    ...
    trailerLink: Joi.string()
      ...
      .messages({
        ...
        'string.pattern.base': 'Поле `trailerLink` должно быть валидным URL-адресом',
    ...
    thumbnail: Joi.string()
      ...
      .messages({
        ...
        'string.pattern.base': 'Поле `thumbnail` должно быть валидным URL-адресом',
...
module.exports.validateMovieId = celebrate({
  params: Joi.object().keys({
    movieId: Joi.string()
      ...
      .length(24)
      .messages({
        'string.hex': 'ID фильма может содержать только латинские буквы[a-f] и цифры',
